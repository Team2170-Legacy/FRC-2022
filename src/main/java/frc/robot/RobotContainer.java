...
private final RamseteController autoController = new RamseteController();
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("AutoControl", new AutoControl(autoController));
    ...
    m_chooser.setDefaultOption("AutoControl", new AutoControl(autoController));
